        ...
        public static class ArithmeticCoding
        {
            public static CompressionResult Compress(string text)
            {
                ...
                return new CompressionResult()
                {
                    ...
                    compressionRatio = (float)System.Math.Round(compressedBitsTotal * 100 / (float)originalBits) / 100,
                };
            }
            ...
            {
                public Fraction resultFraction;
                public Dictionary<char, Fraction> frequencyTable;
                public long originalBits, compressedBitsMessage, compressedBitsTotal, exportedBits;
                public float compressionRatio, exportedCompressionRatio;
